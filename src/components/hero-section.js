  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 opacity-20 z-0 pointer-events-none">
        <div className="absolute top-20 left-20 w-96 h-96 bg-pink-500 rounded-full mix-blend-multiply filter blur-xl animate-blob"></div>
        <div className="absolute top-40 right-20 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl animate-blob2"></div>
        <div className="absolute -bottom-8 left-1/2 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl animate-blob3"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
        ...
        <div className="text-center lg:text-left pt-16 animate-fade-in-up">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
            <span className="text-gradient-pink animate-gradient">
              <Typewriter text="Shadchika Shanmugarasa" speed={80} delay={3000} />
            </span>
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-6 font-medium animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            Code. Data. Impact.
          </p>
          <p className="text-base sm:text-lg text-gray-400 mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="flex justify-center lg:justify-start space-x-4 sm:space-x-6 mb-8">
            <a
              ...
              className="text-gray-400 hover:text-pink-500 text-xl sm:text-2xl transition-all duration-300 hover:scale-125 hover:rotate-12"
              aria-label="LinkedIn"
            >
        ...
        <div className="flex justify-center lg:justify-end order-first lg:order-last">
          <div className="relative z-[60] animate-scale-in">
            {/* Gradient ring with pulse effect */}
            <div className="w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 rounded-full p-2 bg-gradient-to-br from-pink-500 via-purple-500 to-blue-500 flex items-center justify-center animate-pulse-ring hover:scale-105 transition-transform duration-300">
              ...
              <div className="w-full h-full rounded-full bg-black flex items-center justify-center overflow-hidden relative group">
                {!imgError ? (
                  <img
                    ...
                    className="w-full h-full object-cover rounded-full animate-photo-float group-hover:scale-110 transition-transform duration-500"
                    onError={() => setImgError(true)}
                  />
                ) : (
                  <div className="w-full h-full flex items-center justify-center animate-photo-float">
                    <svg
                ...
                {/* Glow effect overlay */}
                <div className="absolute inset-0 rounded-full animate-photo-glow pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
            </div>
          </div>
        </div>
